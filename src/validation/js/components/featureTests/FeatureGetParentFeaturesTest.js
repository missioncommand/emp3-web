...
class FeatureGetParentFeaturesTest extends Component {
  constructor(props) {
    super(props);
  ...
  getParents() {
    ...
    try {
      feature.getParents({
        onSuccess: cbArgs => {
          toastr.success('Retrieved the features parent features(' + cbArgs.features.length + ')');
          this.setState({
...
FeatureGetParentFeaturesTest.propTypes = {
...
export default connect(mapStateToProps)(FeatureGetParentFeaturesTest);
