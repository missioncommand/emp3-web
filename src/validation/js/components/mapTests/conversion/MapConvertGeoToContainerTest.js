...
class MapConvertGeoToContainerTest extends Component {
  constructor(props) {
    super(props);
  ...
  convertGeo() {
    ...
    try {
      let calculated = map.geoToContainer({
...
MapConvertGeoToContainerTest.propTypes = {
