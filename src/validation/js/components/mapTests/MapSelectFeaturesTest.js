...
class MapSelectFeaturesTest extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className='mdl-layout'>
        <h3>Select Features on a Map</h3>
...
MapSelectFeaturesTest.propTypes = {
  maps: PropTypes.array.isRequired,
  features: PropTypes.array.isRequired
};

export default MapSelectFeaturesTest;
