...
com.octabits.starfish.NerveLocal = function(args) {
    ...
    this.id = "localnerve"; //com.octabits.starfish.utils.getUrlParameterByName("armId");
...
com.octabits.starfish.hub = (function() {
    ...
    this.localNerve = new com.octabits.starfish.NerveLocal();
    ...
    this.receiveMessage = function(event) {
        ...
        if (arm !== null || event.data.sender.id === "localnerve") {
            var msg = event.data;
