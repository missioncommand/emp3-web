...
*/
        ...
        renderMPGraphic: function(oArgs)
            //{instanceInterface, isSelected, sID, sName, sDescription, sSymbolCode, oCoordData, oModifiers, i2525Version}
        {
            var iOutputFormat = 2;
            var oMap = oArgs.instanceInterface.getLeafletMap();
            var oMapBounds = oMap.getBounds();
            ...
            var oSouthWest = oMapBounds.getSouthWest().wrap();
            var oNorthEast = oMapBounds.getNorthEast().wrap();
            var oDimension = oMap.getSize();
            var sBBox = oSouthWest.lng + "," + oSouthWest.lat + "," + oNorthEast.lng + "," + oNorthEast.lat;
                ...
                var oLeaftletGeoJSON = new L.GeoJSON(oGeoJson, {
                    ...
                    pointToLayer: function(oGeoJsonfeature, latlng){
                        ...
                        var iTextPixelDim = emp.helpers.getStringPixelDimensions(sLabelText,
                            ...
                            oGeoJsonfeature.properties.fontSize,
                        ...
                        myIcon = new L.DivIcon({
                            ...
                            html: "<p " + 
                                    ...
                                    "font-size:" + oGeoJsonfeature.properties.fontSize + "; " +
                                    "line-height: 1.2; " +
                                    "white-space: nowrap; " +
