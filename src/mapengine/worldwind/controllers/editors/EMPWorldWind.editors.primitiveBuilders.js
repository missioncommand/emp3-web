  ...
  function createShapeAttributes(feature, selectionStyle) {
    ...
    function _createPlacemarkAttributes(feature, selectionStyle) {
      ...
      if (feature.properties.iconUrl) {
        ...
        if (emp.utilities.getDefaultIcon().iconUrl === feature.properties.iconUrl )
        {
          //fix offset for default iconUrl. cmapi is sending the wrong offset.
          attributes.imageOffset = new WorldWind.Offset(WorldWind.OFFSET_FRACTION, emp.utilities.getDefaultIcon().offset.x, WorldWind.OFFSET_PIXELS, emp.utilities.getDefaultIcon().offset.y);
        }
