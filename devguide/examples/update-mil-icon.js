// Create an overlay to caontion the MilStdSymbol
// If no geoId is provided, a UUID is auto generated for the overlay
var overlay1 = new emp3.api.Overlay({
    name: "overlay1"
});

// Genernate a random latitude for the symbol
var lat = Math.random() * 10;
// Geenrate a random longitude for the symbol
var lon = Math.random() * 100;
// create a MilStdSymbol instace which can be added to the overlay
