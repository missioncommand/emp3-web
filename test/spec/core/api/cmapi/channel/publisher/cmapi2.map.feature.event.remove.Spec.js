describe('cmapi.channel.publisher[CMAPI2_FEATURE_EVENT_REMOVE]#map.feature.event.remove', function() {
  var sandbox;
  beforeEach(function() {
  ...
  describe('process', function() {
    ...
    it('constructs a message to send over CMAPI', function() {
      ...
      cmapi.channel.publisher[cmapi.channel.names.CMAPI2_FEATURE_EVENT_REMOVE].process(transaction);
