describe('emp3.api.ResponseBroker.handleCreateOverlayTransactionComplete', function() {
  var broker, sandbox;
  beforeEach(function() {
    sandbox = sinon.sandbox.create();
    broker = emp3.api.ResponseBrokerFactory.getBroker(emp3.api.enums.channel.createOverlay);
  });
